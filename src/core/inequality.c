...
Interval solve_ineq(const int con, const int coeff, const Op op,
                    const int target) {
...
Interval solve_ineq_sys(const int x_con, const int x_coeff, const int y_con,
                        const int y_coeff, const Interval xi,
                        const Interval yi) {
